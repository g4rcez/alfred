...
function Version(mode) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var e, content, packageJson, newVersion, message, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, github_1.default.countStash()];
                case 1:
                    e = _a.sent();
                    content = e[1];
                    if (content === "") {
                        packageJson = JSON.parse(files_1.getPackageJson());
                        newVersion = versionUpdate_1.default(packageJson.version, mode);
